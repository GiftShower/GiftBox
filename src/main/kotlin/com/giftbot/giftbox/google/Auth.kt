...
object Auth {
    ...
    fun authorize(scopes: List<String?>?, credentialDatastore: String?): Credential {
        ...
        // Load client secrets.
        val clientSecretReader: Reader = InputStreamReader(
            Objects.requireNonNull(
                Auth::class.java.getResourceAsStream("/client_secrets.json")
            )
        )
        ...
        val fileDataStoreFactory =
            FileDataStoreFactory(File(System.getProperty("user.home") + "/" + CREDENTIALS_DIRECTORY))
